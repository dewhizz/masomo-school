...
const handleSubmit=async(e)=>{
    ...
    try {
        ...
        const res=await axios.post('https://school-api-fexk.onrender.com/api/classroom/',data,authHeader)
      ...
      <div className="card p-4 shadow-sm mb-4">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type='submit' className="btn btn-success">
            <i className='bi bi-save me-2'>Save Class</i>
          </button>
        </form>
      </div>
    </div>
